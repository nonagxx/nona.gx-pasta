...
UI = UI.init("nena.gx", "pasta.by.nena.gx", "Pasta")
...
local AimOne, AimTwo = UI:AddTab("Aim", "Silent Aim") do
	...
	Section:AddToggle({
     ...
     Section:AddToggle({
		...
		Section:AddToggle({
            title = "speed some bypass",
            desc = "add so many speed",
            callback = function()
